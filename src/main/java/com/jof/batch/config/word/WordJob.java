...
public class WordJob {
    ...
    private final Step readWordsFromFileAndChangeCaseStep;
    private final Step readWordsBackInAndReverseStep;

    @Bean(name = "importWordsJob")
    public Job importWords(){
    ...
    public RepositoryItemReader<Word> retrieveWordsFromDB(){
        ...
        sortMap.put("word", Sort.Direction.ASC);
